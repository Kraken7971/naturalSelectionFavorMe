...
public:
	...
	microbe(microbe &parent){
        ...
        // Placing Mechanism
        this->defaultX = (int)(parent.defaultX + 0.8*ran(0));
        this->defaultY = (int)(parent.defaultY + 0.8*ran(0));
...
void microbe::die(){
	...
	if(!OFF_THE_EDGE){
		world[defaultY][defaultX].foodA += 15.0;
		world[defaultY][defaultX].foodB += 12.0;
	}
	return;
}
